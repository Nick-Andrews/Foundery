...
class book_users extends \foundery\core {
	...
	*/ 
	 ...
	 */
	public function get_nonstatus_users(){
		global $wpdb;
	 ...
	 * @return [null]    
	 */
	public function display_user($d=null){
	 ...
	 * @return [null]    
	 */
	public function display_non_aligned($d=null){
		$wrap = $this->dom->createElement("li");
...
<?php
	 ...
	 * @param  [string] $status  , user status type
	 * @param  [integer] $ID , WP user ID 
	 * @return [null]     
	 */
	public function update_user($status="", $ID=0){
		global $wpdb;
	 ...
	 */
	public function add_new_user( $email="", $status=""){
		global $wpdb;
	 ...
	 * @return [null] 
	 */
	public function create_holders(){
